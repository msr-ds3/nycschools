...
this is naive assumption that students are zoned to the same schools every year. Below is NOT the most accurate!
#ERROR!XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
```{R}
