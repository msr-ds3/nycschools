...
actual_vals <-
  ...
  summarise(avg_dropout=mean(did_not_continue))

actual_vals %>%
  ggplot(aes(x=grade_level, y=avg_dropout, color=ethnicity)) +
  geom_point() +
  facet_wrap(~ sex)
```
...
model_5_stats_on_artificial_test_with_features_3$grade_level <- factor(model_5_stats_on_artificial_test_with_features_3$grade_level, levels = order(c('grade_level.1', 'grade_level1', 'grade_level2', 'grade_level3', 'grade_level4', 'grade_level5', 'grade_level6', 'grade_level7', 'grade_level8', 'grade_level9', 'grade_level10', 'grade_level11', 'grade_level12', 'grade_level13')))

model_5_stats_on_artificial_test_with_features_2 %>%
  group_by(grade_level, ethnicity, sexM) %>%
  summarise(avg_dropout=mean(p_did_not_continue)) %>%
  ggplot(aes(x=grade_level, y=avg_dropout, color=ethnicity, group=ethnicity)) +
  geom_line() +
  scale_x_discrete(limits=c('grade_level.1', 'grade_level1', 'grade_level2', 'grade_level3', 'grade_level4', 'grade_level5', 'grade_level6', 'grade_level7', 'grade_level8', 'grade_level9', 'grade_level10', 'grade_level11', 'grade_level12', 'grade_level13'), labels=c('grade_level.1'='Pre-K', 'grade_level1'='1', 'grade_level2'='2', 'grade_level3'='3', 'grade_level4'='4', 'grade_level5'='5', 'grade_level6'='6', 'grade_level7'='7', 'grade_level8'='8', 'grade_level9'='9', 'grade_level10'='10', 'grade_level11'='11', 'grade_level12'='12', 'grade_level13'='Graduated')) +
...
7. Split % caught plot by grade
8. Put actual values on plot of predicted avg_dropout by grade_level
9. Deal with supression of grade_level0
